    ...
    bool CanChangeCardPaymentMode = false)
{
    ...
    public string AmountText => Amount is decimal value
        ...
        : "Ödeme belirlenmedi";
    public string AssignedSalaryText => AssignedPeriodDate == default
        ? string.Empty
        : $"Karşılayan dönem: {AssignedPeriodDate.ToString("dd MMMM", TurkishCulture)}";
    public bool HasAssignedSalary => AssignedPeriodDate != default;
    public bool IsExpense => Semantic == DetailSemanticType.Expense;
}
