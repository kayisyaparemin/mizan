...
public sealed partial class CoinFlowService
{
    ...
    public Task SavePaymentAssignmentStrategyAsync(
        PaymentAssignmentStrategy strategy,
        bool confirmedHistoricalCorrection = false,
        CancellationToken cancellationToken = default) =>
        obligationService.SavePaymentAssignmentStrategyAsync(
            strategy,
    ...
    public Task DeletePaymentAssignmentStrategyAsync(
        ...
        bool confirmedHistoricalCorrection = false,
        CancellationToken cancellationToken = default) =>
        obligationService.DeletePaymentAssignmentStrategyAsync(
            id,
            confirmedHistoricalCorrection,
            cancellationToken);
