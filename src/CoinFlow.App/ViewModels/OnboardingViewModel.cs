...
public partial class OnboardingViewModel : ViewModelBase
{
    ...
    public ObservableCollection<SelectionOption<PaymentAssignmentMode>> AssignmentModes { get; } =
    [
    ...
    private OnboardingDraft BuildDraft()
    {
        ...
        return new OnboardingDraft
        {
            ...
            {
                SalaryDay = salaryDay,
                MonthlyLivingBudget = ParseNonNegativeMoney(MonthlyLivingBudget, "Yaşam gideri"),
            ...
            InitialPaymentAssignmentMode = SelectedAssignmentMode?.Value ?? PaymentAssignmentMode.UpcomingPeriod
        };
    }
