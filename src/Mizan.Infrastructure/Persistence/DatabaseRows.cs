...
internal sealed class SettingsRow
{
    ...
    [Column("MonthlyLivingBudget")]
    public decimal MonthlyVariableExpenseAllowance { get; set; }
    [Column("ProjectionStartingSavings")]
    ...
    [Column("PaymentAssignmentMode")]
    public int CashFlowAllocationMode { get; set; }
...
internal sealed class CashFlowAllocationStrategyRow
{
    [PrimaryKey] public string Id { get; set; } = string.Empty;
    public int Mode { get; set; }
    [Indexed(Unique = true)]
    [Column("EffectiveFromSalaryDate")]
    public string EffectiveFromPeriodDate { get; set; } = string.Empty;
    public string CreatedAt { get; set; } = string.Empty;
    public string Note { get; set; } = string.Empty;
}
