...
internal sealed class PeriodActualRow
{
    ...
    [Column("DerivedEndingSavings")]
    public decimal DerivedEndingBalance { get; set; }
    [Column("ConfirmedEndingSavings")]
...
internal sealed class SimulationDraftConditionRow
{
    ...
    [Column("NewPaymentAssignmentMode")]
    public int? NewCashFlowAllocationMode { get; set; }
    [Column("EffectiveSalaryDate")]
    public string? EffectivePeriodDate { get; set; }
