    ...
    IUserFeedbackService feedback) : ViewModelBase
{
    ...
    public async Task LoadAsync()
    {
        ...
        try
        {
            ...
            PlannedLiving = Money(finalPlan.PlannedVariableExpenseAllowance, 2);
            PlannedInterest = Money(finalPlan.PlannedInterest, 2);
            PlannedEnding = Money(finalPlan.PlannedEndingBalance, 2);
            ...
            _plannedLiving = finalPlan.PlannedVariableExpenseAllowance;
    ...
    private async Task RefreshPreviewAsync()
    {
        ...
        ComparisonPlannedEnding = Money(preview.Comparison.PlannedEndingBalance, 2);
