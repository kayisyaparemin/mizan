...
public partial class ProfileSelectionPage : ContentPage
{
    ...
    protected override async void OnAppearing()
    {
        ...
        {
            // Soğuk açılışta dialog veya izin akışındaki herhangi bir hata
            // uygulamanın çökmesine (crash on start) sebep olmamalıdır.
            _viewModel.MarkBackupAccessOffered();
            System.Diagnostics.Debug.WriteLine($"Açılış uyarısı: {exception}");
        }
    }
